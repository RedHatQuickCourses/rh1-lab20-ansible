...
image::create-inventory-001.png[create-inventory-001,100%,100%]
...
image::lab003-002.png[lab003-002,100%,100%]

Let's add a host to the inventory. Now click on Hosts

image::lab003-003.png[lab003-003,100%,100%]

Click on Create hosts:

image::lab003-004.png[lab003-004,100%,100%]

Name: localhost

Click on create host:

image::lab003-005.png[lab003-005,100%,100%]

Now with the host created:

image::lab003-006.png[lab003-006,100%,100%]

Go back to the inventory and disable the host:

image::lab003-007.png[lab003-006,100%,100%]
...
image::lab003-009.png[lab003-009,100%,100%]

Confirming that you created the ec2-user user:

image::lab003-010.png[lab003-010,100%,100%]
...
image::lab003-011.png[lab003-011,100%,100%]
...
image::lab003-015.png[lab003-015,100%,100%]

This error will occur:

image::lab003-013.png[lab003-013,100%,100%]

To solve this, we will add this configuration to the job settings:

image::lab003-014.png[lab003-014,100%,100%]
...
image::lab003-016.png[lab003-016,100%,100%]

image::lab003-017.png[lab003-017,100%,100%]
...
image::lab003-018.png[lab003-018,100%,100%]
...
image::lab003-020.png[lab003-020,100%,100%]

Let's create the project in EDA:

Click em Create Project:

image::lab003-021.png[lab003-021,100%,100%]
...
image::lab003-022.png[lab003-022,100%,100%]
...
image::lab003-023.png[lab003-023,100%,100%]
image::lab003-024.png[lab003-024,100%,100%]
...
image::lab003-027.png[lab003-027,100%,100%]
...
image::lab003-025.png[lab003-025,100%,100%]

image::lab003-028.png[lab003-028,100%,100%]

Click on Create rulebook activation

Now in Running:

image::lab003-032.png[lab003-032,100%,100%]

Let's click on the rulebook: rh1-aap-extra-vars-eda

image::lab003-033.png[lab003-033,100%,100%]

Let's go to History:

image::lab003-034.png[lab003-034,100%,100%]

Click on the rulebook that is in Running:

image::lab003-035.png[lab003-035,100%,100%]
