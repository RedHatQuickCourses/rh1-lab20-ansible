...
* If you are not already logged in to the bastion when you open the terminals. Log in to them now:
...
NOTE: To avoid being logged out, modify Settings -> Platform gateway -> Edit platform gateway settings and changing the Session cookie age to 7200. You will need to logout and log back in to implement the change.
